...
class ExternalLinkRestrictionQueryObject extends QueryObject
{
    const OBJECT_NAME = "ExternalLinkRestriction";

    public function selectExplanations(ExternalLinkRestrictionExplanationsArgumentsObject $argsObject = null)
    {
