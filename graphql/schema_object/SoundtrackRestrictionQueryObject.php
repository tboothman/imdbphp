...
class SoundtrackRestrictionQueryObject extends QueryObject
{
    const OBJECT_NAME = "SoundtrackRestriction";

    public function selectExplanations(SoundtrackRestrictionExplanationsArgumentsObject $argsObject = null)
    {
