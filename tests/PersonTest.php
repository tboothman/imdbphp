...
class PersonTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_movies_actor()
    {
        ...
        $this->assertEquals(['voice'], $result[0]['addons']);
    }
...
//    $this->assertEquals('', $result[0]['addons']);
    ...
    public function test_movies_director()
    {
        ...
        $this->assertEquals(Title::MOVIE, $windRises['title_type']);
        $this->assertEquals('', $windRises['chid']);
        //@TODO this says 'Director' .. doesn't seem right
        //$this->assertEquals('', $result[0]['chname']);
        $this->assertEquals([], $windRises['addons']);
        ...
        $this->assertEquals(Title::SHORT, $mrDough['title_type']);
        $this->assertEquals('', $mrDough['chid']);
        $this->assertEquals([], $mrDough['addons']);
        ...
        $this->assertEquals(Title::TV_SERIES, $sherlockHound['title_type']);
        $this->assertEquals('', $sherlockHound['chid']);
        $this->assertEquals([], $sherlockHound['addons']);
    }
    ...
    public function test_movies_thanx()
    {
        ...
        $this->assertEquals([], $laLuna['addons']);
    }
    ...
    public function test_movies_self()
    {
        ...
        $this->assertEquals([], $movie['addons']);
    }
