...
class TitleTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $config = new Config(dirname(__FILE__) . '/resources/test.ini');
        $imdb = new Title('0133093', $config);
    ...
    public function test_constructor_with_custom_logger()
    {
        ...
        $imdb = new Title('some rubbish', null, $logger);
    ...
    public function test_constructor_with_custom_cache()
    {
        ...
        $imdb = new Title('', null, null, $cache);
        $imdb->title();
        Mockery::close();
    }
    ...
    public function testTitle_different_language()
    {
        ...
        $title = new Title(3110958, $config);
    ...
    public function testYearspan_for_a_tv_show_that_havent_ended()
    {
        ...
        $this->assertEquals(['start'=>2015,'end'=>0], $imdb->yearspan());
    }

    public function testYearspan()
    {
        $imdb = $this->getImdb("0306414");
        $this->assertEquals(['start'=>2002,'end'=>2008], $imdb->yearspan());
    }
    ...
    {
        $imdb = $this->getImdb();
        $this->assertEquals(['English'], $imdb->languages());
    }
    ...
    {
        $imdb = $this->getImdb();
        $this->assertEquals(['USA'], $imdb->country());
    }
    ...
    public function testMpaa_hist()
    {
        $imdb = $this->getImdb('0120737');
        $mpaa = $imdb->mpaa_hist();
        if (!isset($mpaa['United States']) && !in_array(['PG-13','PG-13'], $mpaa['United States'], true)) {
            $this->assertFalse(true);
        }
    }
    ...
    public function testWriting_tv()
    {
        ...
        $this->assertEquals(['imdb' => '0800108', 'name' => 'David Simon', 'role' => '(creator) (60 episodes, 2002-2008)'], $credits[0]);
    }
    ...
    public function testComposer_movie()
    {
        ...
        $this->assertEquals(['imdb' => '0204485','name' => 'Don Davis', 'role' => null], $composers[0]);
    }
    ...
    public function testComposer_series()
    {
        ...
        $composers = $imdb->composer();
        $this->assertCount(1, $composers);
        $this->assertEquals(['imdb' => '0006107', 'name' => 'Joel Goldsmith', 'role' => '(40 episodes, 2009-2011)'], $composers[0]);
    }
